...
extension SurfaceExstension on Surface {
  String getTitle(BuildContext context) {
    switch (this) {
      case Surface.indoor:
        return AppLocalizations.of(context)!.indoorTitle;
      default:
        return AppLocalizations.of(context)!.grassTitle;
    }
  }
  ...
  String getDescription(BuildContext context) {
    switch (this) {
      case Surface.indoor:
        return AppLocalizations.of(context)!.indoorDesc;
      default:
        return AppLocalizations.of(context)!.grassDesc;
    }
  }
  ...
  String getImagePath() {
    switch (this) {
      case Surface.indoor:
        return "assets/sportcenters/indoor_thumb.png";
      default:
        return "assets/sportcenters/grass_thumb.png";
    }
  }
}
...
class SportCenter {
  ...
  SportCenter.fromJson(Map<String, dynamic>? json, String documentId)
      : placeId = documentId,
        ...
        _surface = Surface.values
            .where((e) => e.name == json["surface"].toString().toLowerCase())
            .first,
        ...
        _imagesUrls = json["largeImageUrls"] == null
            ? null
            : List<String>.from(json["largeImageUrls"]!);
  ...
  Map<String, dynamic> toJson() => {
        ...
        if (hasChangingRooms != null) 'hasChangingRooms': hasChangingRooms!,
        'courtType': courtType,
        if (_thumbnailUrl != null) 'thumbnailUrl': _thumbnailUrl!,
        if (_imagesUrls != null) "largeImageUrls": _imagesUrls
      };
  ...
  Widget getThumbnail() {
    ...
    return Container(
      ...
      image: DecorationImage(
        image:
            Image.asset("assets/sportcenters/${_surface.name}_thumb.png").image,
        fit: BoxFit.fill,
      ),
      borderRadius: BorderRadius.all(Radius.circular(10)),
    ));
  ...
  List<Widget> getCarouselImages() {
    ...
    return [
      Container(
        ...
        image: DecorationImage(
          image:
              Image.asset("assets/sportcenters/${_surface.name}_carousel.png")
                  .image,
          fit: BoxFit.fill,
        ),
        borderRadius: BorderRadius.all(Radius.circular(10)),
