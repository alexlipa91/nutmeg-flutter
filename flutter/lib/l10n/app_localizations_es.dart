...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get fullRefund => 'un reembolso completo';

  @override
  String get refundWithoutFee =>
      'un reembolso (excluyendo la tarifa de servicio de Nutmeg)';
  ...
  String refundInfo(String info) {
    return 'Si abandonas el partido, recibirás $info.\nSi se cancela el partido, recibirás un reembolso completo.\nSi no te presentas, no recibirás ningún reembolso.';
  }
  ...
  String payoutInfoOnItsWayText(String a, String d) {
    return 'El pago de $a está en camino y debería llegar el $d';
  }
  ...
  @override
  String get stripeIntegrationActive => 'Integración con Stripe activa';
  ...
  String get stripeVerificationPending =>
      'Tu cuenta está configurada pero la verificación aún está en curso. Podrás recibir pagos cuando Stripe complete la revisión.';
