...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get statsNotEnoughRatingsTitle => 'Pontuações não calculadas';

  @override
  String get statsNotEnoughRatingsSubtitle =>
      'Esta partida não recebeu avaliações bastantes de todos os jogadores para calcular as pontuações finais.';

  @override
  String get statsRatingsUnavailableSubtitle =>
      'As avaliações desta partida não puderam ser finalizadas. Tenta mais tarde ou contacta o suporte se continuar.';

  @override
  String get statsRatingsUnavailableTitle => 'Estatísticas indisponíveis';
  ...
  @override
  String get matchSavedStatus => 'Partida salva';
  ...
  String removePlayerRefundMessage(String name) {
    return '$name será reembolsado no método de pagamento utilizado.';
  }
  ...
  String get leftMatchContactOrganizerForRefund =>
      'Entre em contato com o organizador para qualquer reembolso';
  ...
  @override
  String get pictureTitleText => 'Imagem';

  @override
  String get informationTitleText => 'Informações';
  ...
  String imageTooSmallError(int minWidth, int minHeight) {
    return 'Imagem muito pequena. Use pelo menos ${minWidth}x${minHeight}px.';
  }

  @override
  String get invalidImageRatioError =>
      'Proporção de imagem inválida. Use uma imagem próxima de 2:1 (por exemplo 1200x600).';
  ...
  String get nutmegPayCollectedSoFarSubtitle =>
      'Este é o dinheiro recolhido até agora dos jogadores.';
  ...
  @override
  String get stripeIntegrationActive => 'Veja como funciona';

  @override
  String get goToStripeDashboardButton => 'IR PARA O PAINEL DO STRIPE';

  @override
  String get payWithNutmegNotConfigured =>
      'Configuração necessária. Toque para configurar.';
  ...
  String get stripeVerificationPending =>
      'A configuração do Stripe não está completa. Toque em \'Pagar com Nutmeg\' acima para terminar e começar a receber pagamentos.';
  ...
  @override
  String get addGuestLabel => 'Adicionar convidado';

  @override
  String get addGuestTitle => 'Adicionar jogador convidado';

  @override
  String get addGuestSubtitle =>
      'Insira o nome visível do jogador convidado abaixo';

  @override
  String get guestNameHint => 'Nome do convidado';

  @override
  String get pickFromPlayersSubtitle =>
      'Escolha entre os jogadores com quem já jogou';

  @override
  String get searchByNameHint => 'Pesquisar por nome';

  @override
  String get noPlayersAvailable => 'Nenhum jogador disponível para adicionar';
  ...
  String dontForgetToPay(Object name, Object amount) {
    return 'Não se esqueça de pagar $name $amount!';
  }

  @override
  String get androidInstallBannerMessage =>
      'Instale a app da Nutmeg para uma melhor experiência.';

  @override
  String get androidInstallBannerDownload => 'Transferir';

  @override
  String get androidInstallBannerLater => 'Mais tarde';
}
